define('m/sight/topiclist', [
    ...
    var bindEvents = {
            ...
            initList: function () {
                ...
                getRemoteList.getTopicList(params);
            },
    ...
    var renderHTML = function (tpl, data) {
        ...
        $('#topic_list .content-box .topic_name').dotdotdot();
    };
