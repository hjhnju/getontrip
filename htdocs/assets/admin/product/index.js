         ...
         var initTable = function() {
             oTable = $('#editable').dataTable({
                 ...
                 "columns": [{
                     ...
                     "data": function(e) {
                         return '<a class="btn btn-primary btn-xs edit" title="编辑" data-toggle="tooltip" href="/admin/product/edit?action=edit&id=' + e.id + '"><i class="fa fa-pencil"></i></a>';

                         return '<a class="btn btn-primary btn-xs edit" title="编辑" data-toggle="tooltip" href="/admin/product/edit?action=edit&id=' + e.id + '"><i class="fa fa-pencil"></i></a>' + '<button type="button" class="btn btn-danger btn-xs delete"  title="删除" data-toggle="tooltip"><i class="fa fa-trash-o "></i></button>';
         ...
         var bindEvents = {
             ...
             initEvents: function() {
                 ...
                 $('#editable button.publish,#editable button.cel-publish').live('click', function(e) {
                     ...
                     var publish = new Remoter('/admin/productapi/save');
                     publish.remote({
                         id: data.id,
                         action: action
                     });
...
*/
                     ...
                     function changeWeight(id, from, to, sight_id, fromIndex, toIndex) {
                         $.ajax({
                             "url": "/admin/productapi/changeWeight",
                             "data": {
                                 id: id,
                                 to: to,
                                 sightId: sight_id
                 ...
                 $('#editable button.all-action').live('click', function(e) {
                     ...
                     var publish = new Remoter('/admin/productapi/changeStatus');
                     publish.remote({
                         idArray: idArray,
                         action: action
                     });
             ...
             editPic: function() {
                 ...
                 $("#ModalUpload-btn").click(function(event) {
                     var upload = new Remoter('/admin/productapi/save');
                     upload.remote({
                         id: $('#image-id').val(),
                         image: $('#image').val()
                     });
