...
define(function(require) {
    ...
    var tpl = require('../sight/list.tpl');

    var Remoter = require('common/Remoter');


    var getTopicList = new Remoter('CITY_TOPIC_LIST');
    var getFoodList = new Remoter('CITY_FOOD_LIST');
    var getSpecialtyList = new Remoter('CITY_SPECIALTY_LIST');
    var getLandscapeList = new Remoter('CITY_LANDSCAPE_LIST');
    var getBookList = new Remoter('CITY_BOOK_LIST');
    var getVideoList = new Remoter('CITY_VIDEO_LIST');
    ...
    var bindEvents = {
        ...
        initClick: function() {
            $('.list').delegate('li', 'click', function(event) {
                ...
                //window.location = href + (!Number(tagId) ? '&' : '?') + '&tagId=' + tagId + '&cd=' + cityId;
            })
    ...
    var getRemoteList = {
        ...
        getRemoteListSuccess: function() {
            ...
            getLandscapeList.on('success', function(data) {
                ajaxCallbackfun(data, "returnCityLandscapeList", $('#list_landscape'));
            });
            //话题列表 成功
