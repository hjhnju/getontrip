(function (f) {
    'function' === typeof define && define.amd ? define('common/extra/jquery.nicescroll.min', ['jquery'], f) : f(jQuery);
}(function (f) {
    var y = !1, D = !1, N = 0, O = 2000, x = 0, H = [
            'webkit',
            'ms',
            'moz',
            'o'
        ], s = window.requestAnimationFrame || !1, t = window.cancelAnimationFrame || !1;
    if (!s)
        for (var P in H) {
            var E = H[P];
    ...
    var v = window.MutationObserver || window.WebKitMutationObserver || !1, I = {
            ...
            a.hasanimationframe ? a.hascancelanimationframe || (t = function () {
                ...
                return setTimeout(a, 15 - Math.floor(+new Date() / 1000) % 16);
            }, t = clearInterval);
            this.init = function () {
                a.saved.css = [];
                ...
                if (!a.ispage || !e.cantouch && !e.isieold && !e.isie9mobile) {
                    ...
                    a.opt.horizrailenabled && (a.css(b, { 'overflow-x': 'hidden' }), g = f(document.createElement('div')), g.css({
                        ...
                        '-moz-border-radius': a.opt.cursorborderradius,
                        'border-radius': a.opt.cursorborderradius
                    }), e.isieold && g.css({ overflow: 'hidden' }), g.wborder = parseFloat(g.outerWidth() - g.innerWidth()), g.addClass('nicescroll-cursors'), a.cursorh = g, l = f(document.createElement('div')), l.attr('id', a.id + '-hr'), l.addClass('nicescroll-rails nicescroll-rails-hr'), l.height = Math.max(parseFloat(a.opt.cursorwidth), g.outerHeight()), l.css({
                        height: l.height + 'px',
                        zIndex: a.zindex,
                        background: a.opt.background
                    ...
                    a.ispage ? (c.css({
                        ...
                        top: '0px',
                        height: '100%'
                    }), c.align ? c.css({ right: '0px' }) : c.css({ left: '0px' }), a.body.append(c), a.railh && (l.css({
                        position: 'fixed',
                        left: '0px',
                        width: '100%'
