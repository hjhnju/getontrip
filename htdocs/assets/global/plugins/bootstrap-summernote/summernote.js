...
(function(factory) {
    ...
    var Editor = function(handler) {
        ...
        this.currentStyle = function(target) {
            var rng = range.create();
            return rng && rng.normalize() ? rng.isOnEditable() && style.current(rng, target) : false;
        };
        ...
        var tplDialogInfo = {
            image: function(lang, options) {
                ...
                var body = '<div class="form-group row-fluid note-group-select-from-files">' +
                    ...
                    '<input class="note-image-input" id="note-image-input" type="file" name="file" accept="image/*" multiple="multiple" />' +
                    imageLimitation +
                    '</div>' +
