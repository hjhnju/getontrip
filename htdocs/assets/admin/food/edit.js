                ...
                $("#upload-img").click(function(event) {
                    $.ajaxFileUpload({
                        ...
                        success: function(res, status) { //当文件上传成功后，需要向数据库中插入数据
                            ...
                            localStorage.foodimage = res.data.image;
                        },
        ...
        var validations = function() {
            $.validator.setDefaults({
                submitHandler: function(data) {
                    ...
                    var url = '';
                    if (!$('#id').val()) {
                        url = '/admin/foodapi/add';
                    } else {
                        url = "/admin/foodapi/save"
                    }
                    //按钮disabled
                    ...
                    $.ajax({
                        ...
                        "success": function(response) {
                            ...
                            if (response.status == 0) {
                                localStorage.foodimage = '';
                                toastr.success('保存成功');
                                  if (url.indexOf('add') >= 0) {
                                    //resetForm();
                                    window.location.href = '/admin/food/edit?action=edit&id=' + response.data;
                                } else {
