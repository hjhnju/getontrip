         ...
         var bindEvents = {
             ...
             initEvents: function() {
                 ...
                 $('#editable button.publish,#editable button.cel-publish').live('click', function(e) {
                     ...
                     var publish = new Remoter('/admin/specialtyapi/save');
                     publish.remote({
                         id: data.id,
                         action: action
                     });
               ...
               //设为必吃
                 ...
                 $('#editable button.weight').live('click', function(e) {
                     ...
                     function changeWeight(id, from, to, destination_id, destination_type,fromIndex, toIndex) {
                         $.ajax({
                             "url": "/admin/specialtyapi/changeWeight",
                             "data": {
                                 id: id,
                                 to: to,
                 ...
                 $('#editable button.all-action').live('click', function(e) {
                     ...
                     var publish = new Remoter('/admin/specialtyapi/changeStatus');
                     publish.remote({
                         idArray: idArray,
                         action: action
                     });
             ...
             editPic: function() {
                 ...
                 $("#ModalUpload-btn").click(function(event) {
                     var upload = new Remoter('/admin/specialtyapi/save');
                     upload.remote({
                         id: $('#image-id').val(),
                         image: $('#image').val()
                     });
